...
public class GuiStatue extends GuiScreenPlus
{
	...
	public GuiStatue(InventoryPlayer inv, final TileEntityStatue te, World par2, int x, int y, int z)
	{
		...
		addChild(new Gui2dScroller(121, 92, 43, 13, "statues:textures/gui-sculpt.png", 13, 13, 243, 0, setIra(te.pose.itemRightA), 0)
		{
			@Override
			void onChange()
			{
		...
		addChild(new Gui2dScroller(12, 92, 43, 13, "statues:textures/gui-sculpt.png", 13, 13, 243, 0, setIla(te.pose.itemLeftA), 0)
		{
			@Override
			void onChange()
			{
