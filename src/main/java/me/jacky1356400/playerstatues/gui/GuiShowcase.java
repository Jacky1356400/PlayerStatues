...
public class GuiShowcase extends GuiContainer {
	...
	public GuiShowcase(InventoryPlayer inv, TileEntityShowcase teshowcase, World par2, int i, int j, int k) {
		super(new ContainerShowcase(teshowcase, inv));
		invg = inv;
		tile = teshowcase;
		xSize = 256;
		ySize = 226;
	...
	protected void drawGuiContainerForegroundLayer() {
		...
		fontRenderer.drawString(tile.getName(), 72, -7, 0x808080);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		GeneralClient.bind("playerstatues:textures/gui-showcase.png");
