...
public class SlotPickBlock extends Slot {
    ...
    void click(EntityPlayer player, ItemStack itemstack, int count) {
        ...
        container.resultSlot.putStack(newSize <= 0 ? null : new ItemStack(itemstack.getItem(), newSize, itemstack.getItemDamage()) != null ? newSize <= 0 ? null : new ItemStack(itemstack.getItem(), newSize, itemstack.getItemDamage()) : null);
    }
