package me.jacky1356400.playerstatues.helper;
...
public class Packets extends MessageHandlerBase {
	...
	public void onSculptureCreation(Packet packet, EntityPlayer player) throws IOException {
		...
		player.worldObj.setBlock(x, y, z, PlayerStatues.statue,face,3);
		...
		player.worldObj.setBlock(x, y+1, z, PlayerStatues.statue, face|4,3);
		player.worldObj.notifyBlocksOfNeighborChange(x, y, z, PlayerStatues.statue);
